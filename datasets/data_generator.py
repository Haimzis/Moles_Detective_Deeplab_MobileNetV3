...
_MOLES_DETECTOR_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 10164,  # num of samples in images/training
        'val': 3388,  # num of samples in images/validation
        },
    num_classes=2,
    ignore_label=255,
)

_ISIC2018 = DatasetDescriptor(
    splits_to_sizes={
        'train': 2464,  # num of samples in images/training
        'val': 130,  # num of samples in images/validation
        },
    num_classes=2,
    ignore_label=255,
)
...
_DATASETS_INFORMATION = {
    ...
    'moles_detector': _MOLES_DETECTOR_INFORMATION,
    'ISIC2018': _ISIC2018
}
