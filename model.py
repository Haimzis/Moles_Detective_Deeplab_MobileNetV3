...
"DeepLab: Semantic Image Segmentation with Deep Convolutional slim.nets,
Atrous Convolution, and Fully Connected CRFs",
Liang-Chieh Chen*, George Papandreou*, Iasonas Kokkinos, Kevin Murphy,
Alan L Yuille (* equal contribution)
(https://arxiv.org/abs/1606.00915)

"Semantic Image Segmentation with Deep Convolutional slim.nets and Fully Connected
CRFs"
Liang-Chieh Chen*, George Papandreou*, Iasonas Kokkinos, Kevin Murphy,
Alan L. Yuille (* equal contribution)
...
from model.core import dense_prediction_cell
from model.core import feature_extractor
...
def predict_labels_multi_scale(images,
  ...
  Args:
    ...
    model_options: A ModelOptions instance to configure model.
...
def multi_scale_logits(images,
  ...
  Args:
    ...
    nas_training_hyper_parameters: A dictionary storing hyper-parameters for
      training nas model. Its keys are:
