...
flags.DEFINE_integer('min_resize_value', 250,#None,
                     'Desired size of the smaller image side.')

flags.DEFINE_integer('max_resize_value', 250,#None
...
flags.DEFINE_string('model_variant', 'mobilenet_v3_large_seg', 'DeepLab model variant.')
...
flags.DEFINE_integer(
    ...
    'Number of filters of the stem output tensor in NAS model.')
