...
def get_model_gradient_multipliers(last_layers, last_layer_gradient_multiplier):
  ...
  variables. For the task of semantic segmentation, the model are
  usually fine-tuned from the model trained on the task of image
  classification. To fine-tune the model, we usually set larger (e.g.,
